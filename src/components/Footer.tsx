...
import { Phone, Mail, MapPin, ScanFace, InspectionPanel } from "lucide-react";
            ...
            <div className="flex gap-3">
              {[
                ...
                <a
                  ...
                  href={href}
                  aria-label={label}
                  className="w-8 h-8 border border-gold-700/30 flex items-center justify-center text-gold-500/60 hover:text-gold-300 hover:border-gold-500/50 transition-all duration-300"
                >
                  <Icon size={14} />
                </a>
              ))}
          ...
          <div>
            ...
            <div className="space-y-4">
              <a href="tel:+15125550100" className="flex items-start gap-2.5 group">
                ...
                <span className="font-sans text-xs text-gold-100/45 group-hover:text-gold-400 transition-colors">(512) 555-0100</span>
              </a>
